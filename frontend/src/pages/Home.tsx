...
export type Category = "All" | "Watch" | "Mac" | "Phone" | "Earphone" | "iPad" | "Accessories";
...
const CATEGORIES: Category[] = ["All", "Watch", "Mac", "Phone", "Earphone", "iPad", "Accessories"];
...
const MOCK_PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    description: "Feature-rich smartwatch with health tracking and GPS functionality.",
    price: 299.99,
    rating: 4.8,
    badge: "New",
    category: "Watch",
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1612363228621-9731d53c6492?w=500&h=500&fit=crop",
  },
  {
    id: 10,
    name: "iPhone 15",
...
const Home: React.FC = () => {
  ...
  const { data: products, isLoading } = useGet<Product[]>(
    "/api/products",
    undefined,
